...
namespace graph {
	...
	void visualizeSide(Face& face1, Face& face2, Face& face3, Face& face4, bool colore) { // colore = se � vero colora tutte le matrici, se � falso solo la seconda
		for (int r = 0; r < 3; r++) {
			std::cout << graph::visualizeRow(face1, r, colore);
			std::cout << graph::visualizeRow(face2, r, true); // la seconda matrice � sempre colorata
